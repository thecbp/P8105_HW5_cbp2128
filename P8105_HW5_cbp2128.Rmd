...
The true proportion of unsolved homicide cases in Baltimore, MD is between `r prop_tibble$conf.low` and `r prop_tibble$conf.high` with 95% confidence. With this workflow in mind, we can expand it to the rest of the cities.

```{r iterated-prop-test, message = FALSE }
